...
cfg = Config.fromfile('../configs/cascade_rcnn/cascade-mask-rcnn_vitmae_b16_sfpn_600e_coco.py')
...
cfg.work_dir = './tutorial_exps/cascade-mask-rcnn_vitmae_b16_sfpn_600e_coco_lowlr/'
