...
cfg = Config.fromfile('../configs/cascade_rcnn/cascade-mask-rcnn_r101_fpn_200e_coco_lowlr.py')
...
cfg.work_dir = './tutorial_exps/cascade-mask-rcnn_r101_fpn_200e_coco_lowlr/'
