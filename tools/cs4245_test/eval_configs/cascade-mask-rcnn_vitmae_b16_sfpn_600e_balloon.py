model = dict(
    ...
    neck=dict(type='SimpleFPN', d_in=768, d_out=256),
    rpn_head=dict(
        type='RPNHead',
        in_channels=256,
        feat_channels=256,
...
test_evaluator = dict(
    ...
    format_only=False,
    backend_args=None)
train_cfg = dict(type='EpochBasedTrainLoop', max_epochs=600, val_interval=30)
...
resume = False
metainfo = dict(classes=('balloon', ), palette=[(220, 20, 60)])
work_dir = './tutorial_exps/cascade-mask-rcnn_vitmae_b16_sfpn_600e_coco_lowlr/'
